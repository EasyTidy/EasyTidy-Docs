...
![Running Logs page (image placeholder)](/images/en/running-logs-placeholder.png)
...
![Enabling the Keep Version History conflict policy (image placeholder)](/images/en/logs-enable-version-history-placeholder.png)
...
![Version Management view (image placeholder)](/images/en/logs-version-management-placeholder.png)
...
![Full version rollback confirmation (image placeholder)](/images/en/logs-repository-rollback-placeholder.png)
...
![Individual file version history (image placeholder)](/images/en/logs-file-version-history-placeholder.png)
