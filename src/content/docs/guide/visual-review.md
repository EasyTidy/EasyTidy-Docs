...
![Pending Review entry and numeric badge](/images/zh/visual-review-entry.png)
...
![PendingReview staging directory for pending files](/images/zh/visual-review-pending-folder.png)
...
![Pending Review page master-detail layout](/images/zh/visual-review-page-overview.png)
...
![Changing category and confirming a single file](/images/zh/visual-review-confirm-single.png)
...
![Pending Review batch operation differences](/images/zh/visual-review-batch-actions.png)
...
![Previewable and non-previewable states](/images/zh/visual-review-preview-states.png)
...
![Runtime immediate confirmation dialog](/images/zh/visual-review-runtime-dialog.png)
